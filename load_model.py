...
os.environ['CUDA_VISIBLE_DEVICES'] = '0' # Using the GPU first visible to tensorflow for training

# Initialize the Variable
error_rate = 0.8
reverse = True
model_path = '/content/seq2seq_epoch_10.h5'
hidden_size = 128
sample_mode = 'argmax'
data_path = '/content/'
ref = ['ref.docx']
...
if __name__ == '__main__':
    ...
    input_tokens, decoded_tokens = decode_sequences(misspelled_tokens, input_ctable, target_ctable,
